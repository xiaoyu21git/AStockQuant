...
ApplicationWindow {
    ...
    function initializeApp() {
        ...
        Qt.callLater(function() {
            ...
            try {
                ...
                // 测试FactorLibraryPage
                var pageComponent = Qt.createComponent("qrc:/ConsoleUi/Qml/page/FactorLibraryPage.qml")
    ...
    function getStackIndex(menuCode) {
        ...
        var secondaryMenuToIndex = {
            ...
            "data_source_management": 0, // 数据源管理 -> 数据管理 (索引0)
            "strategy_creation": 1,    // 策略创建 -> 策略开发 (索引1)
            "strategy_backtest": 1,    // 策略回测 -> 策略开发 (索引1)
            "strategy_optimization": 1, // 策略优化 -> 策略开发 (索引1)
