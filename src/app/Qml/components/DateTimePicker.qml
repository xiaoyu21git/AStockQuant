...
Popup {
    ...
    readonly property color colorSurfaceVariant: "#222222"
    readonly property color colorBorder: "#444444"
    readonly property color colorBorderLight: "#555555"
    ...
    readonly property color colorTextSecondary: "#aaaaaa"
    readonly property color colorTextTertiary: "#888888"
    readonly property color colorTextDisabled: "#444444"

    readonly property color colorHover: "#333333"
    readonly property color colorHoverLight: "#444444"
    readonly property color colorHoverDark: "#555555"

    readonly property color colorScrollbar: "#555555"
    readonly property color colorScrollbarHover: "#666666"
    readonly property color colorScrollbarPressed: "#888888"

    readonly property color colorDisabled: "#555555"

    property string dateTime: Qt.formatDateTime(new Date(), "yyyy-MM-dd hh:mm:ss")
    property string dateFormat: "yyyy-MM-dd"
    property string timeFormat: "hh:mm:ss"
    // 是否显示右侧时间选择列；为 false 时只选日期
        ...
        Rectangle {
            ...
            Label {
                ...
                text: Qt.formatDateTime(
                          new Date(selectedDate.getFullYear(), selectedDate.getMonth(), selectedDate.getDate(), selectedHour, selectedMinute, selectedSecond),
        ...
        RowLayout {
            ...
            ColumnLayout {
                ...
                GridLayout {
                    ...
                    Layout.fillHeight: true
                    columns: 7
                    rowSpacing: 2      // 缩小纵向行间距
                    columnSpacing: 4   // 保持横向不变
                    ...
                    Repeater {
                        ...
                        Rectangle {
                            Layout.fillWidth: true
                            Layout.fillHeight: true
                            Layout.minimumHeight: 24   // 减小单元格高度
                            radius: 3
            ...
            // 右侧时间选择区域（可选）
            RowLayout {
                Layout.preferredWidth: showTime ? 210 : 0
                Layout.fillHeight: true
                spacing: 8
                visible: showTime
