...
BaseQuantCard {
    ...
    performanceMetrics: [
        {
            ...
            format: "%.2f",
            unit: "%",
            color: returns >= 0 ? BaseComponents.Constants.profitGreen : BaseComponents.Constants.lossRed,
            tooltip: "累计收益率"
        },
        {
            label: "夏普比率",
        ...
        },
        {
            ...
            format: "%.2f",
            unit: "%",
            color: maxDrawdown >= 0 ? BaseComponents.Constants.lossRed : categoryColor,
            tooltip: "最大历史亏损"
        },
        {
            label: "胜率",
    ...
    additionalMetrics: [
        ...
        },
        {
            ...
            color: dailyPnL >= 0 ? BaseComponents.Constants.profitGreen : BaseComponents.Constants.lossRed,
            tooltip: "当日盈亏金额"
        },
        {
            label: "持仓",
    ...
    Item {
        ...
        Row {
            ...
            Rectangle {
                ...
                height: 28
                radius: 6
                color: Qt.rgba(status === "RUNNING" ? BaseComponents.Constants.warningAmber.r : BaseComponents.Constants.profitGreen.r, 
                              status === "RUNNING" ? BaseComponents.Constants.warningAmber.g : BaseComponents.Constants.profitGreen.g, 
                              status === "RUNNING" ? BaseComponents.Constants.warningAmber.b : BaseComponents.Constants.profitGreen.b, 0.2)
                
                Text {
                    anchors.centerIn: parent
                    text: status === "RUNNING" ? "⏸" : "▶"
                    font.pixelSize: 12
                    color: status === "RUNNING" ? BaseComponents.Constants.warningAmber : BaseComponents.Constants.profitGreen
                }
            ...
            Rectangle {
                ...
                height: 28
                radius: 6
                color: Qt.rgba(BaseComponents.Constants.lossRed.r, BaseComponents.Constants.lossRed.g, BaseComponents.Constants.lossRed.b, 0.2)
                
                Text {
                    anchors.centerIn: parent
                    text: "■"
                    font.pixelSize: 12
                    color: BaseComponents.Constants.lossRed
                }
            ...
            Rectangle {
                ...
                height: 28
                radius: 6
                color: Qt.rgba(BaseComponents.Constants.accentBlue.r, BaseComponents.Constants.accentBlue.g, BaseComponents.Constants.accentBlue.b, 0.2)
                
                Text {
                    anchors.centerIn: parent
                    text: "⚙"
                    font.pixelSize: 12
                    color: BaseComponents.Constants.accentBlue
                }
            ...
            Rectangle {
                ...
                color: showParameterPanel ? Qt.rgba(categoryColor.r, categoryColor.g, categoryColor.b, 0.2) : 
                                         Qt.rgba(BaseComponents.Constants.textTertiary.r, BaseComponents.Constants.textTertiary.g, BaseComponents.Constants.textTertiary.b, 0.2)
                
                Text {
                    anchors.centerIn: parent
                    text: showParameterPanel ? "▲" : "▼"
                    font.pixelSize: 12
                    color: showParameterPanel ? categoryColor : BaseComponents.Constants.textTertiary
                }
    ...
    Rectangle {
        ...
        radius: 6
        color: BaseComponents.Constants.tertiaryBg
    ...
    function getStrategyTypeColor(strategyType) {
        switch (strategyType) {
            case "趋势策略":
            case "动量策略": return BaseComponents.Constants.accentBlue;
            case "价值策略":
            case "均值回归": return BaseComponents.Constants.warningAmber;
            case "质量策略":
            case "基本面策略": return BaseComponents.Constants.profitGreen;
            case "成长策略":
            case "高增长策略": return BaseComponents.Constants.purpleGradient;
            case "情绪策略":
            case "市场情绪策略": return Qt.color("#EC4899");  // 粉色
            case "波动策略":
            case "套利策略": return BaseComponents.Constants.lossRed;
            case "组合策略":
            case "多因子策略": return Qt.color("#06B6D4");  // 青色
            default: return BaseComponents.Constants.accentBlue;
        }
    }
    ...
    function getParamColor(colorStr) {
        switch (colorStr) {
            case "blue": return BaseComponents.Constants.accentBlue;
            case "green": return BaseComponents.Constants.profitGreen;
            case "red": return BaseComponents.Constants.lossRed;
            case "amber": return BaseComponents.Constants.warningAmber;
            case "purple": return BaseComponents.Constants.purpleGradient;
            default: return BaseComponents.Constants.accentBlue;
        }
    }
