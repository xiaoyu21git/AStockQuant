...
Item {
        ...
        Rectangle {
            ...
            RowLayout {
                ...
                Component.onCompleted: {
                    ...
                    detailCard("年化收益", (perfModel.data(idx, StrategyPerformanceModel.AnnualizedReturnRole) * 100).toFixed(2) + "%", false)
                    detailCard("最大回撤", (perfModel.data(idx, StrategyPerformanceModel.MaxDrawdownRole) * 100).toFixed(1) + "%", false)
                    ...
                    detailCard("利润因子", perfModel.data(idx, StrategyPerformanceModel.ProfitFactorRole).toFixed(2), false)
                }
            }
        }
    ...
    function detailCard(lbl, val, emph) {
        return detailCardComp.createObject(detailRow, { cardLabel: lbl, cardValue: val, cardEmphasize: emph })
    }
