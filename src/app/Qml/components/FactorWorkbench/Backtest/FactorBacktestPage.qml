...
Item {
    ...
    // -- RuntimeParamsDialog 桥接别名: 暴露内部控件 ID 供 JS 函数访问 --
    ...
    property alias runtimeRebalanceDaysField: runtimeParamsDialog.runtimeRebalanceDaysField
    property alias runtimeSignalThresholdField: runtimeParamsDialog.runtimeSignalThresholdField
    property alias runtimeEnableTurnoverLimitBox: runtimeParamsDialog.runtimeEnableTurnoverLimitBox
    property alias runtimeMaxRebalanceTurnoverField: runtimeParamsDialog.runtimeMaxRebalanceTurnoverField
    property alias runtimeTransactionCostField: runtimeParamsDialog.runtimeTransactionCostField
    property alias runtimeSlippageRateField: runtimeParamsDialog.runtimeSlippageRateField
    property alias runtimeRiskFreeRateField: runtimeParamsDialog.runtimeRiskFreeRateField
    property alias runtimeBenchmarkSymbolField: runtimeParamsDialog.runtimeBenchmarkSymbolField
                ...
                Rectangle {
                    ...
                    ColumnLayout {
                        ...
                        FactorSelectionPanel {
                            ...
                            onCompositeChildRemoved: function(instanceId) { root.removeCompositeChild(instanceId) }
                        ...
                        PreflightFailurePanel {}
                    }
                }
            

                        TradingDiagnosticsPanel {
                            id: tradingDiagnosticsPanel
                            Layout.fillWidth: true
                            Layout.preferredHeight: root.executionDiagnosticsRowHeight()
                            visible: root.executionDiagnosticsRowHeight() > 0
                            page: root
                            onToggleFormalTradingDetails: root.formalTradingDetailsExpanded = !root.formalTradingDetailsExpanded
                        }
