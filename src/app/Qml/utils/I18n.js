    ...
    'zh_CN': {
        ...
        'strategyCreation': {
            ...
            'strategyTypeDescriptions': {
                ...
                'trend_breakout': '基于长期均线、阶段新高和趋势强度确认的交易策略，适合中期趋势突破与持有场景',
            ...
            'maxDrawdownLimit': '最大回撤止损',
            'maxDrawdownDescription': '账户回撤达到阈值后触发止损控制（百分比）',
            'turnoverLimit': '当日成交上限',
            'turnoverLimitDescription': '限制当日累计成交金额，超限后不再新增交易',
            'slippageLimit': '滑点容忍度',
            'slippageLimitDescription': '允许的最大成交滑点阈值，超限时拒绝执行',
            'level1Breaker': '一级熔断·预警',
            'level1BreakerDescription': '达到后发出预警并禁止新增仓位',
            'level2Breaker': '二级熔断·减仓',
            'level2BreakerDescription': '达到后触发减仓并停止新增仓位',
            'level3Breaker': '三级熔断·清仓',
            'level3BreakerDescription': '达到后触发清仓并停止当日交易',
            ...
            'longTrendPeriod': '长趋势周期',
            'longTrendPeriodDescription': '长期趋势过滤均线周期，常用于年线级别过滤',
            'breakoutLookbackPeriod': '近高回看周期',
            'breakoutLookbackPeriodDescription': '判断是否接近阶段新高所使用的回看周期',
            'breakoutThreshold': '近高阈值',
            'breakoutThresholdDescription': '收盘价需达到过去回看窗口最高收盘价的比例阈值',
            'adxPeriod': 'ADX周期',
            'adxPeriodDescription': '计算趋势强度 ADX 的周期',
            'adxThreshold': 'ADX阈值',
            'adxThresholdDescription': '只有趋势强度高于该阈值时才允许入场',
            'exitMaPeriod': '出场均线周期',
            'exitMaPeriodDescription': '跌破该均线时触发趋势转弱退出',
            'atrPeriod': 'ATR周期',
            'atrPeriodDescription': '计算 ATR 跟踪止损的波动周期',
            'atrMultiplier': 'ATR倍数',
            'atrMultiplierDescription': '持仓止损距离使用的 ATR 倍数',
            'bollPeriod': '布林带周期',
            ...
            'lookbackWindow': '回溯窗口',
            'lookbackWindowDescription': '计算因子值所需的通用历史数据长度',
            'entryThreshold': '入场阈值',
    ...
    'en_US': {
        ...
        'strategyCreation': {
            ...
            'strategyTypeDescriptions': {
                ...
                'trend_breakout': 'Trading strategy based on long-term trend filters, breakout proximity, and trend-strength confirmation. Suitable for intermediate breakout holding setups',
            ...
            'turnoverLimit': 'Daily Turnover Limit',
            'turnoverLimitDescription': 'Cap daily filled notional and stop adding new trades after the limit is reached',
            'slippageLimit': 'Slippage Limit',
            'slippageLimitDescription': 'Maximum tolerated execution slippage before a trade is rejected',
            'level1Breaker': 'Level 1 Breaker Threshold',
            'level1BreakerDescription': 'Emit warning and block new exposure when reached',
            'level2Breaker': 'Level 2 Breaker Threshold',
            'level2BreakerDescription': 'Force position reduction and stop new exposure when reached',
            'level3Breaker': 'Level 3 Breaker Threshold',
            'level3BreakerDescription': 'Force liquidation and halt trading for the day when reached',
            ...
            'longTrendPeriod': 'Long Trend Period',
            'longTrendPeriodDescription': 'Long-term moving average period used as the main trend filter',
            'breakoutLookbackPeriod': 'Breakout Lookback Period',
            'breakoutLookbackPeriodDescription': 'Lookback window used to judge whether price is near a stage high',
            'breakoutThreshold': 'Near-High Threshold',
            'breakoutThresholdDescription': 'Required ratio between close and the highest close within the lookback window',
            'adxPeriod': 'ADX Period',
            'adxPeriodDescription': 'Period used to calculate ADX trend strength',
            'adxThreshold': 'ADX Threshold',
            'adxThresholdDescription': 'Only allow entries when trend strength exceeds this threshold',
            'exitMaPeriod': 'Exit MA Period',
            'exitMaPeriodDescription': 'Exit when price closes below this moving average',
            'atrPeriod': 'ATR Period',
            'atrPeriodDescription': 'Volatility period used for ATR trailing exits',
            'atrMultiplier': 'ATR Multiplier',
            'atrMultiplierDescription': 'ATR multiple used to place the trailing stop distance',
            'lookbackWindow': 'Lookback Window',
            'lookbackWindowDescription': 'Common historical data window required to calculate factor values',
