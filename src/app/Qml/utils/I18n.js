...
var translations = {
    'zh_CN': {
        ...
        'strategyCreation': {
            ...
            // 步骤2
            'step2Title': '参数配置与优化',
            'step2Description': '配置策略的核心参数和算法设置，支持动态参数生成和优化',
            ...
            // 步骤3
            'step3Title': '风险管理与回测配置',
            'step3Description': '配置策略的风险控制规则和回测环境设置，确保策略的稳健性',
            ...
            'strategyCreatedBacktest': '✅ 策略创建成功！正在启动回测...',
            'backtestStarted': '🚀 策略回测已启动，请查看回测页面...',
            'backtestControllerError': '⚠️ 回测控制器未初始化或策略名称为空',
            'immediateBacktest': '立即回测',
            
            // 对话框消息
            'strategyCreationSuccessDialogTitle': '策略创建成功',
            'strategyCreatedSuccessDialogMessage': '策略已成功创建并保存到策略库！',
            'strategyCreatedSuccessDialogSubtitle': '您可以在策略库中查看和编辑该策略，或立即开始回测。',
            
            // 按钮
            'createAndBacktest': '创建并开始回测',
            'nextStep': '下一步',
    ...
    'en_US': {
        ...
        'strategyCreation': {
            ...
            'step2Description': 'Configure core parameters and algorithm settings with dynamic parameter generation and optimization',
            ...
            'advancedParameters': 'Advanced Parameter Options',
            ...
            'step3Title': 'Risk Management and Backtest Configuration',
            'step3Description': 'Configure risk control rules and backtest environment settings to ensure strategy robustness',
            ...
            'strategyCreatedBacktest': '✅ Strategy created successfully! Starting backtest...',
            'backtestStarted': '🚀 Strategy backtest started, please check backtest page...',
            'backtestControllerError': '⚠️ Backtest controller not initialized or strategy name empty',
            'immediateBacktest': 'Immediate Backtest',
            
            'createAndBacktest': 'Create and Start Backtest',
            'nextStep': 'Next Step',
            ...
            'strategyCreatedSuccessDialogSubtitle': 'You can view and edit this strategy in the strategy library, or start backtesting immediately.'
        },
