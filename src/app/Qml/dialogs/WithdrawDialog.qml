...
Dialog {
    ...
    property real availableBalance: 0
    ...
    ColumnLayout {
        ...
        Rectangle {
            ...
            ColumnLayout {
                ...
                Text {
                    text: "可用账户净值: " + root.availableBalance.toLocaleString(Qt.locale(), 'f', 2)
                    color: "#94a3b8"
                    font.pixelSize: 12
                }
            }
        ...
        RowLayout {
            ...
            Button {
                text: "确认出金"
                enabled: root.normalizedAmount() > 0 && root.normalizedAmount() <= root.availableBalance
                onClicked: {
