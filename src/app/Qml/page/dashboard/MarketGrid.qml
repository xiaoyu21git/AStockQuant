...
Item {
    ...
    readonly property var _sectors: [
        { name:"半导体",   chg:3.52, net:"+2.1亿", color:"#22c55e", sig:"🟢",
          leads: [{sym:"中芯国际",c:5.1},{sym:"北方华创",c:4.2},{sym:"韦尔股份",c:2.8},{sym:"紫光国微",c:2.1},{sym:"长电科技",c:1.5}] },
        { name:"新能源车", chg:2.15, net:"+1.8亿", color:"#22c55e", sig:"🟢",
          leads: [{sym:"比亚迪",c:3.2},{sym:"宁德时代",c:2.1},{sym:"长城汽车",c:1.5},{sym:"赛力斯",c:1.1},{sym:"长安汽车",c:0.8}] },
        { name:"光伏",     chg:1.93, net:"+1.5亿", color:"#22c55e", sig:"🟢",
          leads: [{sym:"隆基绿能",c:2.8},{sym:"通威股份",c:1.9},{sym:"阳光电源",c:1.3},{sym:"晶澳科技",c:0.9},{sym:"天合光能",c:0.6}] },
        { name:"白酒",     chg:-0.35,net:"-0.8亿", color:"#ef4444", sig:"🔴",
          leads: [{sym:"贵州茅台",c:-0.5},{sym:"五粮液",c:-0.3},{sym:"泸州老窖",c:-0.2},{sym:"山西汾酒",c:-0.1},{sym:"洋河股份",c:0.0}] },
        { name:"军工",     chg:1.28, net:"+0.9亿", color:"#22c55e", sig:"🟢",
          leads: [{sym:"中航沈飞",c:1.9},{sym:"航发动力",c:1.2},{sym:"中航西飞",c:0.8},{sym:"洪都航空",c:0.5},{sym:"中航光电",c:0.3}] },
        { name:"人工智能", chg:2.87, net:"+1.2亿", color:"#22c55e", sig:"🟢",
          leads: [{sym:"科大讯飞",c:4.3},{sym:"海康威视",c:2.1},{sym:"浪潮信息",c:1.9},{sym:"大华股份",c:1.3},{sym:"中科曙光",c:0.9}] },
        { name:"证券",     chg:0.88, net:"+0.6亿", color:"#22c55e", sig:"🟢",
          leads: [{sym:"中信证券",c:1.2},{sym:"华泰证券",c:0.9},{sym:"东方财富",c:0.7},{sym:"海通证券",c:0.5},{sym:"国泰君安",c:0.3}] },
        { name:"电力",     chg:-0.52,net:"-0.3亿", color:"#ef4444", sig:"🔴",
          leads: [{sym:"长江电力",c:-0.8},{sym:"华能国际",c:-0.4},{sym:"国电电力",c:-0.3},{sym:"华电国际",c:-0.2},{sym:"大唐发电",c:-0.1}] }
    ]
